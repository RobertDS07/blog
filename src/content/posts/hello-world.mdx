...
<img src="/public/images/articles/welcome/diff-methods-to-render-fe.png" alt="Foto contendo algumas das diferentes formas de renderização que existem no front-end." />
...
<img src="/public/images/articles/welcome/astro-performance-comparison.png" alt="Foto contendo imagem disponibilizada no site do Astro onde mostram um teste de performance onde o astro foi muito bem." />
...
<img src="/public/images/articles/welcome/solid-performance-comparison.png" alt="Foto contendo imagem disponibilizada no site do SolidJs onde mostram um teste de performance onde o Solid foi muito bem." />
...
<img src="/public/images/articles/welcome/tailwind-example.png" alt="Exemplo de como o bundle do tailwind é feito, removendo classes que não utilizamos." />
...
<img src="../../../public/images/articles/welcome/button.png" alt="Foto de um botão exemplificando o que seria um átomo no Atomic Design." />
...
<img src="../../../public/images/articles/welcome/article-card.png" alt="Foto de um card exemplificando o que seria uma molécula no Atomic Design." />
...
<img src="../../../public/images/articles/welcome/article-section.png" alt="Foto de uma seção do meu site exemplificando o que seria um organismo no Atomic Design." />
...
<img src="../../../public/images/articles/welcome/complete-example-of-atomic-design.png" alt="Foto de todas as etapas do atomic design, exemplificando como vamos de um átomo até uma página completa." />
...
<img src="../../../public/images/articles/welcome/template-in-use-example.png" alt="Foto de uma página deste site exemplificando como um template ficaria com dados reais." />
...
<img src="../../../public/images/articles/welcome/layout-example.png" alt="Foto onde mostro uma parte adicional não presente no Atomic Design que seriam os layouts, aqui nesta foto demonstrei o uso dele." />
...
<img src="../../../public/images/articles/welcome/diagrama-blog-fluxo-de-trabalho.png" alt="Foto de um diagrama de fluxo de trabalho mostrando todas as etapas de como funciona para renderizar uma página deste site no seu navegador." />
